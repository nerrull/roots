...
class GranularTexturePlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    GranularTexturePlugin();
    ~GranularTexturePlugin();
...
AK_DECLARE_PLUGIN_CONTAINER(GranularTexture);	// Exposes our PluginContainer structure that contains the info for our plugin
