...
#ifndef GranularTextureConfig_H
#define GranularTextureConfig_H
...
namespace GranularTextureConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 11577;
}

#endif // GranularTextureConfig_H
