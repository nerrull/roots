...
-- Root of the Mutable Instruments eurorack checkout. Sits next to the project
-- by default; override with the MI_EURORACK_DIR environment variable.
local MI_DIR = os.getenv("MI_EURORACK_DIR")
    or path.getabsolute(_OPTIONS["plugindir"] .. "/../../../eurorack")

-- The MI DSP sources this plug-in needs. Everything else in the repository is
-- either hardware drivers or belongs to another module.
local MI_FILES =
{
    MI_DIR .. "/rings/dsp/part.cc",
    MI_DIR .. "/rings/dsp/fm_voice.cc",
    MI_DIR .. "/rings/dsp/resonator.cc",
    MI_DIR .. "/rings/dsp/string.cc",
    MI_DIR .. "/rings/resources.cc",
...
local Plugin = {}
Plugin.name = "ModalResonator"
Plugin.factoryheader = "../SoundEnginePlugin/ModalResonatorFXFactory.h"
Plugin.appleteamid = ""
Plugin.signtoolargs = {}
Plugin.sdk = {}
Plugin.sdk.static = {}
...
-- The authoring project globs the SoundEnginePlugin sources too, so it needs
-- to see the MI headers on the same terms as the static lib.
