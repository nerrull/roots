...
class ModalResonatorPlugin final
...
AK_DECLARE_PLUGIN_CONTAINER(ModalResonator);	// Exposes our PluginContainer structure that contains the info for our plugin
