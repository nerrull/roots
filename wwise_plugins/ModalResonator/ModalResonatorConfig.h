...
#ifndef ModalResonatorConfig_H
#define ModalResonatorConfig_H
...
namespace ModalResonatorConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 31992;
}

#endif // ModalResonatorConfig_H
