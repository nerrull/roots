...
#ifndef SignalScopeFXParams_H
#define SignalScopeFXParams_H

#include <AK/SoundEngine/Common/IAkPlugin.h>
#include <AK/Plugin/PluginServices/AkFXParameterChangeHandler.h>

// Those IDs map to the AudioEnginePropertyID attributes in SignalScope.xml.
static const AkPluginParamID PARAM_SCOPE_ID_ID = 0;
...
struct SignalScopeNonRTPCParams
{
    AkInt32 iScopeId;
    bool bEnabled;
...
struct SignalScopeFXParams
    : public AK::IAkPluginParam
{
    SignalScopeFXParams();
    SignalScopeFXParams(const SignalScopeFXParams& in_rParams);
    ...
    SignalScopeNonRTPCParams NonRTPC;
};

#endif // SignalScopeFXParams_H
