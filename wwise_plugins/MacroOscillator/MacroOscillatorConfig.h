...
#ifndef MacroOscillatorConfig_H
#define MacroOscillatorConfig_H
...
namespace MacroOscillatorConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 31225;
}

#endif // MacroOscillatorConfig_H
