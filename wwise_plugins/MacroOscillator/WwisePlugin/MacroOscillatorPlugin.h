...
class MacroOscillatorPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    MacroOscillatorPlugin();
    ~MacroOscillatorPlugin();
...
AK_DECLARE_PLUGIN_CONTAINER(MacroOscillator);	// Exposes our PluginContainer structure that contains the info for our plugin
