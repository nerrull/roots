...
#include "../SoundEnginePlugin/DrumSynthSourceFactory.h"
...
AK_DEFINE_PLUGIN_CONTAINER(DrumSynth);											// Create a PluginContainer structure that contains the info for our plugin
AK_EXPORT_PLUGIN_CONTAINER(DrumSynth);											// This is a DLL, we want to have a standardized name
AK_ADD_PLUGIN_CLASS_TO_CONTAINER(                                             // Add our CLI class to the PluginContainer
    DrumSynth,        // Name of the plug-in container for this shared library
    DrumSynthPlugin,  // Authoring plug-in class to add to the plug-in container
    DrumSynthSource   // Corresponding Sound Engine plug-in class
);
